exports.BattleAbilities = {
  ...
  battlebond: {
    ...
    shortDesc:
      "After KOing a Pokemon: raises Attack, Sp. Atk, Speed by 1 stage. Once per battle.",
  },
  beadsofruin: {
    name: "Beads of Ruin",
    rating: 4.5,
  ...
  commander: {
    ...
    shortDesc:
      "If ally is Dondozo: this Pokemon cannot act or be hit, +2 to all Dondozo's stats.",
  },
  competitive: {
    name: "Competitive",
    rating: 2.5,
  ...
  costar: {
    ...
    shortDesc:
      "On switch-in, this Pokemon copies all of its ally's stat stage changes.",
  },
  cottondown: {
    name: "Cotton Down",
    rating: 2,
  ...
  curiousmedicine: {
    ...
    shortDesc:
      "On switch-in, this Pokemon's allies have their stat stages reset to 0.",
  },
  cursedbody: {
    name: "Cursed Body",
    rating: 2,
  ...
  flashfire: {
    condition: { noCopy: true, onModifyAtkPriority: 5, onModifySpAPriority: 5 },
    isBreakable: true,
    name: "Flash Fire",
    rating: 3.5,
    num: 18,
  ...
  gorillatactics: {
    ...
    shortDesc:
      "This Pokemon's Attack is 1.5x, but it can only select the first move it executes.",
  },
  grasspelt: {
    onModifyDefPriority: 6,
    isBreakable: true,
  ...
  guarddog: {
    ...
    shortDesc:
      "Immune to Intimidate. Intimidated: +1 Attack. Cannot be forced to switch out.",
  },
  gulpmissile: {
    isPermanent: true,
    name: "Gulp Missile",
    ...
    shortDesc:
      "When hit after Surf/Dive, attacker takes 1/4 max HP and -1 Defense or paralysis.",
  },
  guts: {
    onModifyAtkPriority: 5,
    name: "Guts",
  ...
  icebody: {
    ...
    shortDesc:
      "If Snow is active, this Pokemon heals 1/16 of its max HP each turn.",
  },
  iceface: {
    onDamagePriority: 1,
    isBreakable: true,
  ...
  mimicry: {
    ...
    shortDesc:
      "This Pokemon's types change to match the Terrain. Type reverts when Terrain ends.",
  },
  minus: {
    onModifySpAPriority: 5,
    name: "Minus",
  ...
  multitype: {
    ...
    shortDesc:
      "If this Pokemon is an Arceus, its type changes to match its held Plate.",
  },
  mummy: {
    name: "Mummy",
    rating: 2,
  ...
  overcoat: {
    ...
    shortDesc:
      "This Pokemon is immune to powder moves, Sandstorm damage, and Effect Spore.",
  },
  overgrow: {
    onModifyAtkPriority: 5,
    onModifySpAPriority: 5,
  ...
  powerspot: {
    ...
    shortDesc:
      "This Pokemon's allies have the power of their moves multiplied by 1.3.",
  },
  prankster: {
    name: "Prankster",
    rating: 4,
  ...
  punkrock: {
    ...
    shortDesc:
      "This Pokemon receives 1/2 damage from sound moves. Its own have 1.3x power.",
  },
  purepower: {
    onModifyAtkPriority: 5,
    name: "Pure Power",
  ...
  sandspit: {
    ...
    shortDesc:
      "When this Pokemon is hit by an attack, the effect of Sandstorm begins.",
  },
  sandstream: {
    name: "Sand Stream",
    rating: 4,
  ...
  seedsower: {
    ...
    shortDesc:
      "When this Pokemon is hit by an attack, the effect of Grassy Terrain begins.",
  },
  serenegrace: {
  ...
  stench: {
    ...
    shortDesc:
      "This Pokemon's attacks without a chance to flinch gain a 10% chance to flinch.",
  },
  stickyhold: {
    isBreakable: true,
    name: "Sticky Hold",
  ...
  thermalexchange: {
    ...
    shortDesc:
      "This Pokemon's Attack is raised by 1 when damaged by Fire moves; can't be burned.",
  },
  thickfat: {
    onSourceModifyAtkPriority: 6,
    onSourceModifySpAPriority: 5,
  ...
  unseenfist: {
    ...
    shortDesc:
      "This Pokemon's contact moves ignore the target's protection, except Max Guard.",
  },
  vesselofruin: {
    name: "Vessel of Ruin",
    rating: 4.5,
    ...
    shortDesc:
      "Active Pokemon without this Ability have their Special Attack multiplied by 0.75.",
  },
  victorystar: {
  ...
  wanderingspirit: {
    ...
    shortDesc:
      "Pokemon making contact with this Pokemon have their Ability swapped with this one.",
  },
  waterabsorb: {
    isBreakable: true,
    name: "Water Absorb",
  ...
  windrider: {
    ...
    shortDesc:
      "Attack raised by 1 if hit by a wind move or Tailwind begins. Wind move immunity.",
  },
  wonderguard: {
    isBreakable: true,
    name: "Wonder Guard",
