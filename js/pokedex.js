...
window.PokedexAbilityPanel = PokedexResultPanel.extend({
  initialize: function (id) {
    ...
    if (ability.isNonstandard && ability.id !== "noability")
      buf +=
        '<div class="warning"><strong>Note:</strong> This is a made-up ability by <a href="http://www.smogon.com/cap/" target="_blank">Smogon CAP</a>.</div>';
...
window.PokedexTagPanel = PokedexResultPanel.extend({
  table: {
    ...
    sound: {
      ...
      desc:
        'Bypasses <a href="' +
        Config.baseurl +
        'moves/substitute" data-target="push">Substitute</a>. Doesn\'t affect <a href="' +
        Config.baseurl +
        'abilities/soundproof" data-target="push">Soundproof</a> Pok&eacute;mon.',
    },
    powder: {
      name: "Powder",
      tag: "powder",
      desc:
        "Doesn't affect <a href=\"" +
        Config.baseurl +
        'types/grass" data-target="push">Grass-type</a> Pok&eacute;mon, <a href="' +
        Config.baseurl +
        'abilities/overcoat" data-target="push">Overcoat</a> Pok&eacute;mon, or <a href="' +
        Config.baseurl +
        'items/safetygoggles" data-target="push">Safety Goggles</a> holders.',
    },
    fist: {
      name: "Fist",
      tag: "punch",
    ...
    pulse: {
      ...
      tag: "pulse",
      desc:
        'Boosted 1.5x by <a href="' + Config.baseurl + 'abilities/megalauncher" data-target="push">Mega Launcher</a>.',
    },
    bite: {
      name: "Bite",
      tag: "bite",
    ...
    ballistic: {
      ...
      desc:
        "Doesn't affect <a href=\"" +
        Config.baseurl +
        'abilities/bulletproof" data-target="push">Bulletproof</a> Pok&eacute;mon.',
    },
    slicing: {
      name: "Slicing",
      tag: "slicing",
    ...
    wind: {
      ...
      tag: "wind",
      desc:
        'Pok&eacute;mon with <a href="' +
        Config.baseurl +
        'abilities/windpower" data-target="push">Wind Power</a> gain the charge effect after being hit. Pok&eacute;mon with <a href="' +
        Config.baseurl +
        'abilities/windrider" data-target="push">Wind Rider</a> have their Attack raised by 1 stage and are immune.',
    },
    bypassprotect: {
      name: "Bypass Protect",
      tag: "",
      desc:
        'Bypasses <a class="subtle" href="' +
        Config.baseurl +
        ...
        Config.baseurl +
        'moves/spikyshield" data-target="push">Spiky Shield</a>.',
    },
    nonreflectable: {
      name: "Nonreflectable",
      tag: "",
      desc:
        'Can\'t be bounced by <a class="subtle" href="' +
        Config.baseurl +
        'moves/magiccoat" data-target="push">Magic Coat</a> or <a class="subtle" href="' +
        Config.baseurl +
        'abilities/magicbounce" data-target="push">Magic Bounce</a>.',
    },
    nonmirror: {
      name: "Nonmirror",
      tag: "",
      desc:
        'Can\'t be copied by <a class="subtle" href="' +
        Config.baseurl +
        'moves/mirrormove" data-target="push">Mirror Move</a>.',
    },
    nonsnatchable: {
      name: "Nonsnatchable",
      tag: "",
      desc:
        'Can\'t be copied by <a class="subtle" href="' +
        Config.baseurl +
        'moves/snatch" data-target="push">Snatch</a>.',
    },
    bypasssub: {
      name: "Bypass Substitute",
      tag: "bypasssub",
      desc:
        'Bypasses but does not break a <a class="subtle" href="' +
        Config.baseurl +
        'moves/substitute" data-target="push">Substitute</a>.',
    },
    zmove: {
      name: "Z-Move",
      tag: "",
  ...
  initialize: function (id) {
    ...
    buf +=
      ...
      '" class="pfx-backbutton" data-target="back"><i class="fa fa-chevron-left"></i> Pok&eacute;dex</a>';
    buf +=
      '<h1><a href="' + Config.baseurl + "tags/" + id + '" data-target="push" class="subtle">' + name + "</a></h1>";
...
window.PokedexEggGroupPanel = PokedexResultPanel.extend({
  ...
  initialize: function (id) {
    ...
    if (this.id2) {
      buf +=
        '<p>All Pok&eacute;mon in either the <a href="' +
        Config.baseurl +
        "egggroups/" +
        this.id +
        '" data-target="push">' +
  ...
  getDistribution: function () {
    ...
    for (var pokemonid in BattlePokedex) {
      ...
      if (eggGroups[0] === name || eggGroups[1] === name || eggGroups[0] === name2 || eggGroups[1] === name2) {
...
window.PokedexTierPanel = PokedexResultPanel.extend({
  initialize: function (id) {
    ...
    buf +=
      ...
      '" class="pfx-backbutton" data-target="back"><i class="fa fa-chevron-left"></i> Pok&eacute;dex</a>';
    buf +=
      '<h1><a href="' + Config.baseurl + "tiers/" + id + '" data-target="push" class="subtle">' + name + "</a></h1>";
...
window.PokedexArticlePanel = PokedexResultPanel.extend({
  initialize: function (id) {
    ...
    buf +=
      ...
      '" class="pfx-backbutton" data-target="back"><i class="fa fa-chevron-left"></i> Pok&eacute;dex</a>';
    buf +=
      '<h1><a href="' + Config.baseurl + "articles/" + id + '" data-target="push" class="subtle">' + id + "</a></h1>";
